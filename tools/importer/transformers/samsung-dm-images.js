...
/**
 * Transformer: Samsung UK Dynamic Media / Scene7 image handling.
 * Converts DM <img> tags into anchors so they survive the markdown round-trip.
 * Runs in afterTransform only (after block parsers have extracted img references).
 *
 * Scene7 URLs detected: images.samsung.com/is/image/samsung/...
 * Detection is path-based (/is/image/) per canonical spec — hostname-independent.
 */
