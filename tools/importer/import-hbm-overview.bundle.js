...
var CustomImportScript = (() => {
  ...
  // tools/importer/import-hbm-overview.js
  var import_hbm_overview_exports = {};
  __export(import_hbm_overview_exports, {
    default: () => import_hbm_overview_default
  });
  ...
  var import_hbm_overview_default = {
    transform: (payload) => {
  ...
  return __toCommonJS(import_hbm_overview_exports);
})();
